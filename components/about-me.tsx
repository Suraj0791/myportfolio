      ...
      <Card className="p-8 bg-card border-border animate-in fade-in slide-in-from-bottom-4 duration-1000">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1 space-y-6">
            <div>
              <h3 className="text-2xl font-bold mb-2">Ramkrishna Swarnkar</h3>
              <p className="text-muted-foreground">
                Being a Full Stack Web developer and Open Source Contributor, I specialize in building MVPs, SaaS
                products, and solving real-world problems. I'm passionate about creating seamless user experiences.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Working on innovative web applications using modern technologies like Next.js, React, and Three.js.
                  Always exploring new ways to enhance user experience.
                </p>
              </div>
